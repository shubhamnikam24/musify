...
<body style="background-color: F5F1F0;">
    ...
    ?>
        ...
        <table align="Center">
            <tr>
                <td>
                    <td><a href="busprint.php?pid='<?php echo $_SESSION['tno'] ?>' " target="_blank"><button style="background-color: black ; border-color:black  "><h3><span style="color:white;"> Print Ticket </span></h3></button></a></td>
                </td>
            </tr>
        </table>
    <?php endwhile; ?>
